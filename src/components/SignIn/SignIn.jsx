...
const SignIn = ({ onRouteChange, loadUser }) => {
  const [signInEmail, setSignedInEmail] = useState('');
  const [signInPassword, setSignedInPassword] = useState('');

  const onEmailChange = (e) => {
    setSignedInEmail(e.target.value);
  };

  const onPasswordChange = (e) => {
    setSignedInPassword(e.target.value);
  };
      ...
      <main className="pa4 black-80 w-100 tc">
        <div className="measure ">
          <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
            <legend className="f1 fw6 ph0 mh0 txtCenter">Sign In</legend>
            <div className="mt3">
